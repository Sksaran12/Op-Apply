...
async function main() {
  console.log('Seeding Exam datasets...');
  ...
  const exams = [
    ...
    },
    {
      ...
      applicationFee: 1150,
      startDate: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000),
      endDate: new Date(Date.now() + 3 * 24 * 60 * 60 * 1000), // exactly 3 days remaining (triggers cron warning)
  ...
  console.log('Seeding process complete. 6 examinations successfully created/updated.');
}
